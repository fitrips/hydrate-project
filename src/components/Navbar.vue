<template>
<nav class="flex items-center justify-between bg-white-200 p-0.90 border-b-2 border-grey-100">
    <!-- Konten navbar -->
    <div class="flex items-center flex-1">
        ...
        <h1 class="font-sans text-2xl font-semibold text-center mx-auto"> <!-- Adding mx-auto class here -->
            <span class="gradient-text">HYDRATEHERO</span>
        </h1>
    </div>
     <!-- Lonceng notifikasi -->
<div class="mr-4 relative">
    ...
    <div class="dropdown" id="notification-dropdown">
        <!-- Isi pop-up dropdown di sini -->
        <p>Ini adalah konten dropdown.</p>
    </div>
</div>
</nav>
        ...
        <ul class="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap">Water Count</span>
              <span
